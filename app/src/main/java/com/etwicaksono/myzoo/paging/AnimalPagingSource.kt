...
class AnimalPagingSource(private val apiService: ApiService) : PagingSource<Int, ResponseAnimal>() {
    override fun getRefreshKey(state: PagingState<Int, ResponseAnimal>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ResponseAnimal> {
        return try {
